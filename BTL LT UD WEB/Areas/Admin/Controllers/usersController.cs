...
namespace BTL_LT_UD_WEB.Areas.Admin.Controllers
{
    ...
    public class usersController : Controller
    {
        ...
        public ActionResult Index(string searchStr, int? page)
        {
            ...
            user = user.OrderByDescending(e => e.user_id);
            int pageSize = 10;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "user_id,email, username, fullname,phone,ProvinceID,DistrictID,address, password")] user users)
        {
